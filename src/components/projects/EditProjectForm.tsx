...
// Crear, Editar o eliminar se usa Mutation
// Obtener datos es con Queris
...
export default function EditProjectForm({data, projectId} : EditProjectFormProps) {
    ...
    const { mutate } = useMutation({
        ...
        onSuccess: (data) => {
            queryClient.invalidateQueries({queryKey: ['projects']}) // Siempre se pasa un arreglo
        ...
        <>
            <div className='max-w-3xl mx-auto'>
                ...
                <form
                    ...
                    noValidate // Desavilita la validacion de HTML5
                >
                    <ProjectForm
                        register={register}
                        errors={errors}
